...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2025 a las 01:16:18
...
INSERT INTO `carga_academica` (`id`, `clases_id`, `alumno_id`, `calificacion`) VALUES
(1, 1, 2, 10),
(2, 2, 2, 10),
(3, 3, 2, 10),
(4, 4, 2, 10),
...
--
ALTER TABLE `carga_academica`
  ADD CONSTRAINT `carga_academica_ibfk_1` FOREIGN KEY (`clases_id`) REFERENCES `clases` (`id`),
